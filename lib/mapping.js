...
(function(){
  var hiragana, katakana, hwkatakana, romaji, getMappings, mappings, out$ = typeof exports != 'undefined' && exports || this;
  ...
  romaji = romaji.concat(['-', 'n']);
  out$.romaji = romaji;
  out$.hiragana = hiragana;
  out$.katakana = katakana;
  out$.hwkatakana = hwkatakana;
  getMappings = function(){
    var mapped, i$, to$, ii;
    mapped = {};
    for (i$ = 0, to$ = romaji.length; i$ < to$; ++i$) {
      ii = i$;
      mapped[romaji[ii]] = {
  ...
  out$.mappings = mappings = getMappings();
}).call(this);
